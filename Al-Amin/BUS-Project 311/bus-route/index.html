...
<body id="root-container" style="margin: 0;" onload="initAspectJS()">
    <div data-element-behavior="menu" id="nav-id-586-" data-element-type="section">
        <div id="container-id-587-" data-element-type="container">
            <div id="container-id-602-" data-element-type="container">
                ...
                <a id="button-id-598-" data-element-type="button" href="/"><span id="element-id-599-">HOME</span></a>
                <a id="button-id-600-" data-element-type="button" href="/all-buses"><span id="element-id-601-">Add Bus</span></a>
            </div>
            <div id="container-id-616-" data-element-type="container">
                <a id="button-id-610-" data-element-type="button" href="/"><span id="element-id-611-">Sign In</span></a>
                <a id="button-id-612-" data-element-type="button" href="/sign-up"><span id="element-id-613-">Sign Up</span></a>
    ...
    <div id="content-container">
        <p id="text-id-624-" data-element-type="text">
            <span id="element-id-621-">Welcome</span> to the <span id="element-id-625-">Bus Route Registration</span> Page.&nbsp;<br id="element-id-623-">Please fill out the Following Details to add a new Bus route to our System.
        </p>
        <div id="container-id-666-" data-element-type="container">
            <div data-element-behavior="form" id="form-id-688-" data-element-type="section">
                <form id="container-id-682-" data-element-type="container" onsubmit="return submitAspectForm(this)" data-uid="Uahw3jKSLgUqgwVo62CPkFz1ktX2">
                    <input id="input-id-684-" data-element-type="input" required="true" placeholder="Route Number">
                    <button id="button-id-686-" data-element-type="button" type="submit"><span id="element-id-687-">Add Bus Routes</span></button>
                    <input id="input-id-685-" data-element-type="input" required="true" placeholder="Starting Point">
                    <input id="input-id-683-" data-element-type="input" required="true" placeholder="Destination">
                    <input id="input-id-690-" data-element-type="input" required="true" placeholder="Distance">
                    <input id="input-id-692-" data-element-type="input" required="true" placeholder="Total Fare">
                </form>
            </div>
